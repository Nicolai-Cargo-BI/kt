...
Windows.click(findWindowsObject('CargoBI/Crash Test/Login_Page/Button_Login_disable'))

not_run: Windows.delay(2)

not_run: Windows.click(findWindowsObject('CargoBI/Crash Test/Welcome_Page/Button_DNA'))
