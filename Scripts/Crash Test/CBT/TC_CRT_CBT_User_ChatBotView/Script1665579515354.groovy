...
Windows.setText(findWindowsObject('CargoBI/Crash Test/Login/Edit_Username'), 'User1')
...
Windows.click(findWindowsObject('CargoBI/Crash Test/CBT/Custom_ChatBotWindow'))

Windows.sendKeys(findWindowsObject('CargoBI/Misc/Window_CargoBI_Application'), Keys.chord(Keys.SHIFT, Keys.CONTROL, '9'))
