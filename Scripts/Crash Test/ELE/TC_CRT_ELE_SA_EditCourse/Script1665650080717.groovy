...
Windows.verifyElementPresent(findWindowsObject('CargoBI/Crash Test/ELE/Button_AddCourse'), 0)

Windows.sendKeys(findWindowsObject('CargoBI/Misc/Window_CargoBI_Application'), Keys.chord(Keys.SHIFT, Keys.CONTROL, '0'))
