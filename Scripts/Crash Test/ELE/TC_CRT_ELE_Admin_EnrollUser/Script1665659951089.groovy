...
Windows.click(findWindowsObject('CargoBI/Crash Test/ELE/Button_ELE'))

Windows.verifyElementPresent(findWindowsObject('CargoBI/Crash Test/ELE/Button_EnrollSelected'), 0)

Windows.sendKeys(findWindowsObject('CargoBI/Misc/Window_CargoBI_Application'), Keys.chord(Keys.SHIFT, Keys.CONTROL, Keys.ADD))
