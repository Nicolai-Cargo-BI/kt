...
Windows.verifyElementPresent(findWindowsObject('CargoBI/Crash Test/DNA/Button_SolutionDetails_AddFile'), 0)

CustomKeywords.'com.db.keys.Macro_continue'()

Windows.delay(18)

Windows.verifyElementPresent(findWindowsObject('CargoBI/Crash Test/DNA/Text_Mandatory_Menu'), 0)

Windows.verifyElementNotPresent(findWindowsObject('CargoBI/Crash Test/DNA/Button_SolutionDetails_AddFile'), 0)
