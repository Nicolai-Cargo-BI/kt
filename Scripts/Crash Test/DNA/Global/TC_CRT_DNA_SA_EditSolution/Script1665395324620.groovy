...
Windows.click(findWindowsObject('CargoBI/Crash Test/DNA/Global_DNA/Text_FirstShipmentDNA'))

Windows.click(findWindowsObject('CargoBI/Crash Test/DNA/Global_DNA/Text_Menu3XSKWP8IJF'))

Windows.click(findWindowsObject('CargoBI/Crash Test/DNA/Global_DNA/Text_Solution_4WQ21AHUNT'))

//Windows.sendKeys(findWindowsObject('Other/Window'), Keys.chord(Keys.SHIFT, Keys.CONTROL, '2'))
//Windows.delay(65)
