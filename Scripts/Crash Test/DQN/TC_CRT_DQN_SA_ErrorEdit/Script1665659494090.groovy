...
Windows.verifyElementPresent(findWindowsObject('CargoBI/Crash Test/DQN/Button_SA_btnAddCriteria'), 0)

Windows.delay(85)

Windows.verifyElementNotPresent(findWindowsObject('CargoBI/Crash Test/DQN/Button_Add_AddCriteriaPopUp'), 0)

Windows.verifyElementNotPresent(findWindowsObject('CargoBI/Crash Test/DQN/Button_Add_AddErrorPopUp'), 0)
