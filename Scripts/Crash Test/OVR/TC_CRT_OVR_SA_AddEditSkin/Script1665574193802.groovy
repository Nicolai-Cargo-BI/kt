...
Windows.click(findWindowsObject('CargoBI/Crash Test/OVR/Button_Settings'))

Windows.click(findWindowsObject('CargoBI/Crash Test/OVR/Text_AddEdit'))

Windows.sendKeys(findWindowsObject('CargoBI/Misc/Window_CargoBI_Application'), Keys.chord(Keys.SHIFT, Keys.CONTROL, '6'))
