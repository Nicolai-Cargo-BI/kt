...
Windows.click(findWindowsObject('CargoBI/Scenarie Test/Global/DNA/Edit_tbx_UserName'))

Windows.setText(findWindowsObject('CargoBI/Scenarie Test/Global/DNA/Edit_tbx_UserName'), CustomKeywords.'com.db.keys.Scenarie_test_directory'())
